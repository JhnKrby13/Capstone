...
<head>
    ...
    <link rel="stylesheet" href="photographer2.css">
    ...
    <div class="profile-container">
        ...
        <div class="profile">
            <div class="profile-image">
                <img src="image/photo2.jpg" alt="Profile Picture">
            </div>
            <div class="profile-details">
                <p><strong>Name:</strong> Peter Ventocilla</p>
                <p><strong>Address:</strong> Barangay Ibabang Iyam</p>
                <p><strong>Contact:</strong> 09603498285</p>
                <h2>About Me</h2>
