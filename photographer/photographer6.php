...
<head>
    ...
    <link rel="stylesheet" href="photographer6.css">
    ...
    <div class="profile-container">
        ...
        <div class="profile">
            <div class="profile-image">
                <img src="image/photo6.jpg" alt="Profile Picture">
            </div>
            <div class="profile-details">
                <p><strong>Name:</strong> Mark Magalona</p>
                <p><strong>Address:</strong> Barangay Cotta</p>
                <p><strong>Contact:</strong> 09987654321</p>
                <h2>About Me</h2>
